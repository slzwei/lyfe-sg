...
import { staffVerifyOtp, staffSendOtp } from "../actions";
...
export default function StaffVerifyPage() {
  ...
  useEffect(() => {
    const stored = sessionStorage.getItem("staff_otp_phone");
    if (!stored) {
  ...
  const handleSubmit = useCallback(
    async (digits: string[]) => {
      ...
      const result = await staffVerifyOtp(phone, token);
      if (result.success) {
        sessionStorage.removeItem("staff_otp_phone");
