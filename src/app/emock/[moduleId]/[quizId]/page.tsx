...
import { getInProgressAttempt, clearQuizProgress } from "@/app/emock/actions";
...
export default async function QuizLandingPage({
  ...
  const inProgress = await getInProgressAttempt(moduleId, quizId);
  const answeredCount = inProgress
    ? Object.keys(inProgress.answers).length
    : 0;

  async function handleStartFresh() {
    "use server";
    await clearQuizProgress(moduleId, quizId);
  }
      ...
      {inProgress ? (
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-orange-700 mb-4">
            You have {answeredCount} of {quiz.total_questions} questions
            answered. Your progress is saved.
          </p>
          <div className="flex items-center gap-3">
            ...
            <form action={handleStartFresh}>
              <button
                type="submit"
                className="text-sm text-stone-500 hover:text-red-600 transition-colors underline underline-offset-2"
              >
                Start fresh
              </button>
            </form>
        ...
        <>
          <div className="bg-white rounded-xl border border-stone-200 p-6 mb-6">
            ...
            <ul className="space-y-2.5 text-sm text-stone-700">
              ...
              <li>
                &bull; <strong>Time limit: {quiz.duration} minutes.</strong>{" "}
              ...
              {quiz.grading.type === "two-part" ? (
                <>
                  ...
                  <li className="ml-6">
                    &ndash; You must pass <strong>both parts</strong> to pass
                    the quiz.
                  </li>
                </>
              ) : (
              ...
              <li>
                &bull; <strong>+1</strong> for correct, <strong>0</strong> for
                wrong or blank. No negative marking.
              </li>
              <li>
                &bull; Your progress is auto-saved. You can leave and resume
                anytime.
              </li>
            </ul>
          </div>
